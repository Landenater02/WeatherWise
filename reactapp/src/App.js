...
export default class App extends Component {
    ...
    render() { //render the content
        ...
        if (this.state.widgets.length != 0) {
            pso = this.state.widgets.map((Component,index) => (
        ...
        return (
            ...
            (!this.state.createNewWidget ?
                <div class="container">
                    <h1 id="tabelLabel">Weather Wise</h1>
                    <p>Welcome to WeatherWise, your go-to destination for accurate and up-to-date weather information!</p>
                    <div class="flex-wrap">
                        {pso}
                        <a class="newTile" href="#" onClick={this.handleClick}>
                    ...
                    <div class="container">
                        ...
                        <div class="form">
                            <input class="search" onChange={this.autoComplete} placeHolder="enter a location"></input><ul id="autocomplete-list" class="autocomplete-list">

                                {(this.state.suggestions.length > 0 ?
                                    this.state.suggestions.map(x => <a onClick={() => this.weatherData(x.position.lat, x.position.lon, x.address.freeformAddress)} href="#"><li key={this.state.suggestions.indexOf(x)}> {x.address.freeformAddress} </li></a>) : <li>no input</li>)}
    ...
    async weatherData(lat, long,location) {

        this.state.locationName = location;
        ...
        try {
            ...
            try {
                ...
                //instantiate new widget here
                this.state.widgets.push(<Widget temperature={dataTwo.properties.periods[0].temperature}
                    isDaytime={dataTwo.properties.periods[0].isDaytime}
                    detailedForecast={dataTwo.properties.periods[0].shortForecast} locationName={location} />);
                this.setState({
                    createNewWidget: false
    ...
    async autoComplete(event) {
        if (event.target.value.length >= 3) {
               ...
               let url = `https://api.tomtom.com/search/2/search/${event.target.value}.json?key=OAlookutQBSFpxqbhWqQoiAvFcoH0ccm&typeahead=true&limit=5&countrySet=US`;
     ...
     handleClick = () => {
         this.setState({createNewWidget: true })
    }
 ...
 class NewWidget extends Component {
                   ...
                   render() {
                       return (
                           ...
                           <path d="M25 0V50" stroke="#D9D9D9" stroke-width="10" />
                           <path d="M50 25H0" stroke="#D9D9D9" stroke-width="10" />
                       </svg></div>
...
class Widget extends Component {
    ...
    render() {
        return (
            ...
            <div class="weatherItemWrap">
                {this.state.isDaytime ?
                    <svg class="sun" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" version="1.1"><path d="M512 512m-217.9 0a217.9 217.9 0 1 0 435.8 0 217.9 217.9 0 1 0-435.8 0Z" /><path d="M512 247.4c-13.8 0-25-11.2-25-25v-67.8c0-13.8 11.2-25 25-25s25 11.2 25 25v67.8c0 13.8-11.2 25-25 25zM512 894.6c-13.8 0-25-11.2-25-25v-67.8c0-13.8 11.2-25 25-25s25 11.2 25 25v67.8c0 13.8-11.2 25-25 25zM296.6 339.3c-8.7 10.7-24.4 12.4-35.2 3.7l-52.7-42.7c-10.7-8.7-12.4-24.4-3.7-35.2 8.7-10.7 24.4-12.4 35.2-3.7l52.7 42.7c10.7 8.8 12.3 24.5 3.7 35.2zM816.4 265.3c-8.7-10.7-24.4-12.4-35.2-3.7l-52.7 42.7c-10.7 8.7-12.4 24.4-3.7 35.2 8.7 10.7 24.4 12.4 35.2 3.7l52.7-42.7c10.8-8.7 12.4-24.4 3.7-35.2zM297 681.7c-8.7-10.7-24.4-12.4-35.2-3.7l-52.7 42.7c-10.7 8.7-12.4 24.4-3.7 35.2 8.7 10.7 24.4 12.4 35.2 3.7l52.7-42.7c10.7-8.7 12.3-24.4 3.7-35.2zM816.8 755.8c-8.7 10.7-24.4 12.4-35.2 3.7l-52.7-42.7c-10.7-8.7-12.4-24.4-3.7-35.2 8.7-10.7 24.4-12.4 35.2-3.7l52.7 42.7c10.7 8.7 12.4 24.4 3.7 35.2zM249.3 498.7c0 13.8-11.2 25-25 25h-67.8c-13.8 0-25-11.2-25-25s11.2-25 25-25h67.8c13.8 0 25 11.2 25 25zM896.1 498.7c0 13.8-11.2 25-25 25h-67.8c-13.8 0-25-11.2-25-25s11.2-25 25-25h67.8c13.8 0 25 11.2 25 25z" /></svg>

                    :
                    <svg class="moon" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 344.118 344.118" >
                        <g>
                            <g>
                                <g>
